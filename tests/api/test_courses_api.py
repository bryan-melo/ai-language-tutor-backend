...
class TestCourseAPI():
   ...
   @pytest.mark.parametrize("course_data, status_code", [
      ...
      ({"title": "test_course_3", "author": "test4", "description": "Test course", "num_of_lessons": 100, "category": "Pronunciation & Phonetics", "difficulty": "Beginner"}, status.HTTP_201_CREATED),
   ])
